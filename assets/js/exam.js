      ...
      setTimeout(() => setProgressBarWidth(1), 1000); // Update to 1% after 1 second
        ...
        function startTimer() {
          timerInterval = setInterval(() => {
            if (timeLeft <= 0) {
              ...
              // Show the dark humor quote with animation
              const darkHumorMessage = getDarkHumorMessage("high");
              const darkHumorElement = document.getElementById("darkHumor");
              darkHumorElement.textContent = darkHumorMessage;
              darkHumorElement.classList.add("show");

              document.getElementById("timer").innerHTML =
                "Time is up! Guess that’s the universe’s way of saying you’ve had enough.";

              // Optionally redirect or display a result if needed
        ...
        fetch("questions.json")
          ...
          .then((data) => {
            ...
            function showQuestion(index) {
              ...
              document.getElementById("darkHumor").textContent =
                darkHumorMessage;
            ...
            function updateBookmarkedQuestions() {
              ...
              document
                .querySelectorAll(".remove-bookmark")
                .forEach((button) => {
